...
图灵班人工智能专业\quad 大三 
\begin{itemize}[nosep]
    \item 相关课程：《线性代数(H)》、《高级数据结构与算法分析》、《面向对象程序设计》、 《计算机视觉导论》
\end{itemize}

\section{\makebox[\widthof{\faUsers}][c]{\color{CVBlue}\faUsers}\ 经历}

% --- 第一个项目 ---
% 将标题行末尾的 \\ 替换为 \titlebreak 命令
{计算机辅助蛋白质设计} \hfill 2025.03 -- 至今 \titlebreak
本人与2025年3月进入浙江大学药学院侯廷军老师实验室进行AI For Science的科研学习，之后我在师兄指导下进行计算机辅助蛋白质设计的科研项目实践，具体内容为对现有的从头蛋白质设计方法RSO进行改良，使其由原来的优化logits表示改为全程优化embedding，从而避免丢失过多信息，期望得到更好的设计结果。项目暂未有产出。}。
...
\begin{itemize}
    ...
    \item 2024-2025学年 校设奖学金 浙江大学三等奖学金 \hfill 2023.10
    \item 第13届中国大学生龙舟锦标赛 100米直道/男甲 第五名 \hfill 2025.09
